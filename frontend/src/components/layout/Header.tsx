    ...
    <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-md border-b border-slate-200/80 px-4 md:px-8 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-3">
        <div className="relative" ref={panelRef}>
          ...
          {notificationsOpen && (
            <div className="absolute right-0 top-10 z-40 w-80 rounded-xl border border-slate-200 bg-white shadow-lg overflow-hidden">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-2 py-1.5 text-xs text-slate-700">
