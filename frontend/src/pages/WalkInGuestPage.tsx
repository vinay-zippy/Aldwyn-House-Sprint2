...
export const WalkInGuestPage: React.FC = () => {
  ...
  const validate = () => {
    ...
    else if (!/^[0-9+() .-]{7,20}$/.test(form.phone)) next.phone = 'Enter a valid phone number.'
